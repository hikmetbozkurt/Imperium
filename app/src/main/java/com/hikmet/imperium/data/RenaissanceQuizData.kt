...
object RenaissanceQuizData {
    val level1Questions = listOf(
        Question(
            ...
            options = listOf("France", "Italy", "England", "Spain"),
            correctAnswerIndex = 1
        ),
        Question(
            text = "What does the word 'Renaissance' mean?",
            options = listOf("Rebirth", "Revolution", "Decline", "Discovery"),
            correctAnswerIndex = 0
        ),
        Question(
            text = "Which city is considered the cradle of the Renaissance?",
            options = listOf("Venice", "Florence", "Rome", "Milan"),
            correctAnswerIndex = 1
        ),
        Question(
            text = "Who was a famous patron of Renaissance art in Florence?",
            options = listOf("Medici family", "Borgia family", "Habsburg family", "Tudor family"),
            correctAnswerIndex = 0
        )
    )
    val level2Questions = listOf(
        ...
        Question(
            text = "Which artist is known for the Mona Lisa?",
            options = listOf("Michelangelo", "Raphael", "Leonardo da Vinci", "Botticelli"),
            correctAnswerIndex = 2
        ),
        Question(
            text = "Which technique did Renaissance artists develop for realistic depth?",
            options = listOf("Perspective", "Cubism", "Impressionism", "Fresco"),
            correctAnswerIndex = 0
        ),
        Question(
            text = "Who sculpted David?",
            options = listOf("Donatello", "Michelangelo", "Bernini", "Ghiberti"),
            correctAnswerIndex = 1
        )
    )
    val level3Questions = listOf(
        Question(
            text = "Who is known as the father of modern science during the Renaissance?",
            options = listOf("Galileo Galilei", "Isaac Newton", "Johannes Kepler", "Tycho Brahe"),
            correctAnswerIndex = 0
        ),
        Question(
    ...
    val level4Questions = listOf(
        Question(
            ...
            options = listOf("Raphael", "Leonardo da Vinci", "Michelangelo", "Botticelli"),
            correctAnswerIndex = 0
        ),
        Question(
    ...
    val level5Questions = listOf(
        Question(
            ...
            options = listOf("Johannes Gutenberg", "Aldus Manutius", "William Caxton", "Martin Luther"),
            correctAnswerIndex = 0
        ),
        Question(
    ...
    val level6Questions = listOf(
        Question(
            ...
            options = listOf("Sandro Botticelli", "Leonardo da Vinci", "Raphael", "Titian"),
            correctAnswerIndex = 0
        ),
        Question(
    ...
    val level8Questions = listOf(
        Question(
            text = "Which Renaissance writer is known for 'Don Quixote'?",
            options = listOf("Miguel de Cervantes", "Dante Alighieri", "Ludovico Ariosto", "Boccaccio"),
            correctAnswerIndex = 0
        ),
        Question(
    ...
    val level9Questions = listOf(
        Question(
            text = "Who initiated the Protestant Reformation by posting the Ninety-five Theses?",
            options = listOf("Martin Luther", "John Calvin", "Ulrich Zwingli", "Desiderius Erasmus"),
            correctAnswerIndex = 0
        ),
        Question(
