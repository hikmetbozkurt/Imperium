...
object WorldWarsQuizData {
    val level1Questions = listOf(
        Question(
            text = "What event is widely considered the spark that started World War I?",
            options = listOf("Sinking of the Lusitania", "Assassination of Archduke Franz Ferdinand", "Zimmermann Telegram", "Treaty of Versailles"),
            correctAnswerIndex = 1
        ),
        Question(
            text = "Which countries formed the Triple Entente in WWI?",
            options = listOf("Germany, Austria-Hungary, Italy", "Britain, France, Russia", "USA, Britain, France", "Germany, Ottoman Empire, Bulgaria"),
            correctAnswerIndex = 1
        ),
        Question(
            text = "Which new weapon was first used on a large scale in WWI?",
            options = listOf("Tanks", "Atomic bomb", "Jet aircraft", "Helicopters"),
            correctAnswerIndex = 0
        ),
        Question(
            text = "What year did World War I end?",
            options = listOf("1916", "1917", "1918", "1919"),
    ...
    val level2Questions = listOf(
        Question(
            ...
            options = listOf("Adolf Hitler", "Joseph Stalin", "Winston Churchill", "Benito Mussolini"),
            correctAnswerIndex = 0
        ),
        Question(
    ...
    val level4Questions = listOf(
        Question(
            text = "Who was the British Prime Minister at the start of World War II?",
            options = listOf("Neville Chamberlain", "Winston Churchill", "Stanley Baldwin", "Clement Attlee"),
            correctAnswerIndex = 0
        ),
        Question(
    ...
    val level5Questions = listOf(
        Question(
            text = "Which battle is considered the turning point of the war on the Eastern Front in WWII?",
            options = listOf("Battle of Stalingrad", "Battle of Kursk", "Battle of Moscow", "Battle of Leningrad"),
            correctAnswerIndex = 0
        ),
        Question(
    ...
    val level6Questions = listOf(
        Question(
            text = "Who was the British Prime Minister for most of WWII?",
    ...
    val level7Questions = listOf(
        Question(
            text = "Which event marked the official end of World War II in Europe?",
            options = listOf("Germany's surrender (V-E Day)", "D-Day", "Battle of Berlin", "Yalta Conference"),
            correctAnswerIndex = 0
        ),
        Question(
    ...
    val level8Questions = listOf(
        Question(
            text = "Who was the leader of the Free French Forces during WWII?",
    ...
    val level9Questions = listOf(
        Question(
            text = "Which battle was the last major German offensive on the Western Front in WWII?",
            options = listOf("Battle of the Bulge", "Battle of Berlin", "Battle of Kursk", "Battle of Normandy"),
            correctAnswerIndex = 0
        ),
        Question(
    ...
    val level10Questions = listOf(
        Question(
            text = "Which country was created as a result of the partition of British India in 1947?",
            options = listOf("Pakistan", "Bangladesh", "Sri Lanka", "Nepal"),
            correctAnswerIndex = 0
        ),
        Question(
    ...
    val level11Questions = listOf(
        Question(
            text = "Which country was invaded by Italy in 1935, leading to international condemnation?",
            options = listOf("Ethiopia", "Libya", "Greece", "Albania"),
            correctAnswerIndex = 0
        ),
        Question(
    ...
    val level13Questions = listOf(
        Question(
            text = "Which country was NOT a founding member of the United Nations in 1945?",
            options = listOf("Germany", "United States", "Soviet Union", "United Kingdom"),
            correctAnswerIndex = 0
        ),
        Question(
    ...
    val level14Questions = listOf(
        Question(
            text = "Who was the US President who authorized the use of atomic bombs on Japan?",
            options = listOf("Harry S. Truman", "Franklin D. Roosevelt", "Dwight D. Eisenhower", "John F. Kennedy"),
            correctAnswerIndex = 0
        ),
        Question(
    ...
    val level15Questions = listOf(
        Question(
            text = "Which country was the first to use tanks in battle during WWI?",
            options = listOf("United Kingdom", "France", "Germany", "Russia"),
            correctAnswerIndex = 0
        ),
        Question(
    ...
    val level17Questions = listOf(
        Question(
            text = "Which battle was the first major naval battle of WWI?",
            options = listOf("Battle of Jutland", "Battle of the Falkland Islands", "Battle of Dogger Bank", "Battle of Coronel"),
            correctAnswerIndex = 0
        ),
        Question(
    ...
    val level18Questions = listOf(
        Question(
            text = "Who was the US President during the Korean War?",
            options = listOf("Harry S. Truman", "Dwight D. Eisenhower", "Franklin D. Roosevelt", "John F. Kennedy"),
            correctAnswerIndex = 0
        ),
        Question(
    ...
    val level20Questions = listOf(
        Question(
            text = "Which international organization was founded in 1945 to promote peace and cooperation?",
            options = listOf("United Nations", "League of Nations", "European Union", "NATO"),
            correctAnswerIndex = 0
        ),
        Question(
